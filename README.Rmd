...
The purpose of sxchan is to create and manipulate watercourse geometries, particularly cross sections. Because this package sits on top of the sf package, geometries can also be manipulated in the same way as in the sf package.
